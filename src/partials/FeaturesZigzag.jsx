...
function FeaturesBlocks({ refWhyYouChose }) {
  return (
    <section ref={refWhyYouChose}>
        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-gray-400">
              Our approach allows the client to obtain steady returns in all
              market conditions, while respecting the values of professionalism,
              transparency and safety, and through the use of innovative low
              risk investment techniques.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              <h4 className="h4 mb-2">CONSTANT PROFITS</h4>
            ...
            >
              ...
              <h4 className="h4 mb-2">SIGNAL SERIVCE</h4>
              <p className="text-lg text-gray-400 text-center"></p>
            </div>
            ...
            >
              ...
              <h4 className="h4 mb-2">INDEPENDENCE </h4>
            </div>
            ...
            >
              ...
              <h4 className="h4 mb-2">STEADY RETURNS</h4>
            </div>
            ...
            >
              ...
              <h4 className="h4 mb-2">CONFIDENTIALITY</h4>
            </div>
          </div>
        </div>
      </div>
